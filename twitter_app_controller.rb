...
class Begin
	def init_app
		...
		client = Twitter::REST::Client.new do |config|
		  config.consumer_key        = 'insert your key'
		  config.consumer_secret     = 'insert your key'
		  config.access_token        = 'insert your key'
		  config.access_token_secret = 'insert your key'
		 end
		...
		template = %(
			...
			<div class="mt4 w-100 w-80-m w-60-ns center tc ph3 mb5 mb4-ns">
			  <h1 class="f2 f1-l fw9 gray-90 mb0 lh-title sans-serif">Daily Pixel Arts</h1>
